...
export const CITIES_DATABASE: City[] = [
  ...
  { name: 'Guarapari', country: 'Brasil', aliases: ['Guarapari'] },
  { name: 'Vitória', country: 'Brasil', aliases: ['Vitoria', 'ES'] },
  { name: 'Vila Velha', country: 'Brasil' },
  { name: 'Marataízes', country: 'Brasil', aliases: ['Mararatataizes'] },
  { name: 'Aracruz', country: 'Brasil' },
  { name: 'Domingos Martins', country: 'Brasil' },
  { name: 'Piúma', country: 'Brasil', aliases: ['Piuma'] },
  { name: 'Anchieta', country: 'Brasil' },
  { name: 'Santa Cruz Cabrália', country: 'Brasil' },
  { name: 'Ilhéus', country: 'Brasil', aliases: ['Ilheus'] },
  { name: 'Itabuna', country: 'Brasil' },
  { name: 'Cachoeira', country: 'Brasil' },
  { name: 'Maragogi', country: 'Brasil' },
